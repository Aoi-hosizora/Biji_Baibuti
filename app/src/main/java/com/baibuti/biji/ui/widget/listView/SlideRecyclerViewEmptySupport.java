...
/**
 * https://github.com/shycdw/BlogDemo/blob/master/app/src/main/java/com/example/davidchen/blogdemo/view/SlideRecyclerView.java
 */
public class SlideRecyclerViewEmptySupport extends RecyclerViewEmptySupport {
    ...
    public SlideRecyclerViewEmptySupport(Context context) {
        this(context, null);
    }

    public SlideRecyclerViewEmptySupport(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlideRecyclerViewEmptySupport(Context context, @Nullable AttributeSet attrs, int defStyle) {
